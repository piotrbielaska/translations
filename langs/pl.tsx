...
const messages:IMessages = {
  ...
  "Buckets Guide": {
    /* 'Buckets' refers to the application name. */
    val: "Instrukcja użytkowania programu Buckets",
    translated: true,
  ...
  "Click the \"Set mapping\" to continue.": {
    val: "Kliknij w \"Ustaw mapowanie\" aby kontynuować.",
    translated: true,
  ...
  "Enable to get new versions of Buckets before everyone else.  There might be more bugs :)": {
    val: "Włącz, aby otrzymać nową wersję programu Buckets przed innymi. Program może zawierać błędy :)",
    translated: true,
  ...
  "Enter Buckets License": {
    val: "Wpisz numer licencji programu Buckets",
    translated: true,
  ...
  "File type not recognized.": {
    val: "Nie rozpoznano typu pliku, importowanie nie powiodło się",
    translated: true,
  ...
  "I'm exporting data so that I can ": {
    val: "Eksportuje dane, żebym mógł ",
    translated: true,
  ...
  "Identify the data each column contains using the drop downs below.": {
    val: "Wybierz, korzystając z rozwijalnego menu, typ danych w każdej z kolumn.",
    translated: true,
  ...
  "If multiple columns are selected for Amount, the first non-zero value will be used.  This is helpful if the CSV contains separate Credit and Debit columns.": {
    val: "Pierwsza wartość, inna niż zero, zostanie użyta, jeśli kilka kolumn będzie wybranych jako zawierających Kwotę. Ta funkcjonalność jest pomocna gdy plik CSV zawiera osobno kolumny Kredyt i Debet.",
    translated: true,
  ...
  "Invalid SimpleFIN Token": {
    val: "Nieprawidłowy SimpleFIN Token",
    translated: true,
  ...
  "Language default": {
    val: "Zgodny z ustawionym językiem",
    translated: true,
  ...
  "No orders imported": {
    val: "Zadania nie zaimportowane",
    translated: true,
    h: "BSXGKYKVKCk7fbaNo3wAigIjqpZPNfJFNISloGmngZg=",
  },
  "No refunds imported": {
    val: "Zwroty nie zaimportowane",
    translated: true,
  ...
  "Select the account these transactions belong to.": {
    val: "Wybierz konto do których należą te transakcje.",
    translated: true,
  ...
  "Sync failed": {
    val: "Błąd podczas synchronizacji",
    translated: true,
  ...
  "Thank you for the feedback!": {
    val: "Dziękuję za przesłaną informację!",
    translated: true,
  ...
  "Total amount your buckets expect each month.": {
    val: "Całkowita kwota potrzebna do wypełnienia wszystkich kubełków co miesiąc.",
    translated: true,
  ...
  "Update balance without a transaction": {
    val: "Zmień stan konta bez tworzenia transakcji",
    translated: true,
  ...
  "You must have at least one column each set to Amount, Memo and Date Posted.": {
    val: "Musisz określić co najmniej jedną kolumnę jako Kwotę, Opis lub Datę transakcji.",
    translated: true,
  ...
  "buckettype.goal-deposit": {
    val: "Oszczędź X przez odłożenie Z/mi",
    translated: true,
  ...
  "edit.mapping": {
    val: (onClick) => {
          return <span>Lub <a href="#" onClick={onClick}>edytuj mapowanie.</a></span>
        },
    translated: true,
    h: "hFYUKKIqC+nYQ+RRKwNu3/PGxbtuHzNHoigSJwCK8d4=",
  },
  "enter-license-prompt": {
    val: "\n      Wpisz numer licencji programu Buckets.  Nie masz licencji?  <a href=\"#\" id=\"clicktobuy\">Kliknij aby kupić.</a>\n    ",
    translated: true,
  ...
  "export.why": {
    val: "Być może to co robisz z eksportowanymi danymi, może zostać wbudowane w program Buckets. Chiałbyś poinformować o tym twórcę programu?",
    translated: true,
  ...
  "match-count": {
    val: (current_match:number, total_matches:number) => {
        return `${current_match} z ${total_matches}`;
      },
    translated: true,
...
Czy chciałbyś kupić licencję teraz?`,
  ...
  "sync.toast.syncing": {
    val: (start:moment.Moment, end:moment.Moment) => {
        return `Synchronizuję transakcje od ${start.format('ll')} do ${end.format('ll')}`;
      },
    translated: true,
